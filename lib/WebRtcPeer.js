...
function WebRtcPeer(mode, options, callback) {
  ...
  if (mode !== 'recvonly' && !videoStream && !audioStream) {
    function getMedia(constraints, sendSource) {
      ...
      if (typeof AdapterJS !== 'undefined' && AdapterJS
        ...
        if(sendSource == 'screen' || sendSource == 'window' || ( Array.isArray(sendSource) && (sendSource.includes('window') || sendSource.includes('screen')) )) {
