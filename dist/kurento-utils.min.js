...
function noop(e){e&&console.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,n){var t=[];return e.onsignalingstatechange=function(){if("stable"===this.signalingState)for(;t.length;){var e=t.shift();this.addIceCandidate(e.candidate,e.callback,e.callback)}},function(r,o){switch(o=o||n,e.signalingState){case"closed":o(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(r,o,o);break}default:t.push({candidate:r,callback:o})}}}function removeFIDFromOffer(e){var n=e.indexOf("a=ssrc-group:FID");return n>0?e.slice(0,n):e}function getSimulcastInfo(e){var n=e.getVideoTracks();if(!n.length)return console.warn("No video tracks available in the video stream"),"";var t=["a=x-google-flag:conference","a=ssrc-group:SIM 1 2 3","a=ssrc:1 cname:localVideo","a=ssrc:1 msid:"+e.id+" "+n[0].id,"a=ssrc:1 mslabel:"+e.id,"a=ssrc:1 label:"+n[0].id,"a=ssrc:2 cname:localVideo","a=ssrc:2 msid:"+e.id+" "+n[0].id,"a=ssrc:2 mslabel:"+e.id,"a=ssrc:2 label:"+n[0].id,"a=ssrc:3 cname:localVideo","a=ssrc:3 msid:"+e.id+" "+n[0].id,"a=ssrc:3 mslabel:"+e.id,"a=ssrc:3 label:"+n[0].id];return t.push(""),t.join("\n")}function WebRtcPeer(e,n,t){function r(){if(c){var e=p.getRemoteStreams()[0];c.pause(),attachMediaStream(c,e),c.load()}}function o(e){return S&&("Chrome"===browser.name||"Chromium"===browser.name?(console.log("Adding multicast info"),e=new RTCSessionDescription({type:e.type,sdp:removeFIDFromOffer(e.sdp)+getSimulcastInfo(d)})):console.warn("Simulcast is only available in Chrome browser.")),e}function i(){"closed"===p.signalingState&&t('The peer connection object is in "closed" state. This is most likely due to an invocation of the dispose method before accepting in the dialogue'),d&&s&&C.showLocalVideo(),d&&p.addStream(d),l&&p.addStream(l);var n=parser.getBrowser();"sendonly"!==e||"Chrome"!==n.name&&"Chromium"!==n.name||39!==n.major||(e="sendrecv"),t()}function a(e){void 0===e&&(e=MEDIA_CONSTRAINTS),AdapterJS.webRTCReady(function(n){getUserMedia(e,function(e){d=e,i()},t)})}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,n,t);WebRtcPeer.super_.call(this),n instanceof Function&&(t=n,n=void 0),n=n||{},t=(t||noop).bind(this);var s=n.localVideo,c=n.remoteVideo,d=n.videoStream,l=n.audioStream,u=n.mediaConstraints,f=n.connectionConstraints,p=n.peerConnection,h=n.sendSource||"webcam",v=uuid.v4(),m=recursive({iceServers:freeice()},n.configuration),g=n.onstreamended;g&&this.on("streamended",g);var b=n.onicecandidate;b&&this.on("icecandidate",b);var P=n.oncandidategatheringdone;P&&this.on("candidategatheringdone",P);var S=n.simulcast,R=n.multistream,w=new sdpTranslator.Interop;p||(p=new RTCPeerConnection(m)),Object.defineProperties(this,{peerConnection:{get:function(){return p}},id:{value:n.id||v,writable:!1},remoteVideo:{get:function(){return c}},localVideo:{get:function(){return s}},currentFrame:{get:function(){if(c){if(c.readyState<c.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=c.videoWidth,e.height=c.videoHeight,e.getContext("2d").drawImage(c,0,0),e}}}});var C=this,y=[],D=!1;p.onicecandidate=function(e){var n=e.candidate?{candidate:e.candidate.candidate,sdpMLineIndex:e.candidate.sdpMLineIndex,sdpMid:e.candidate.sdpMid}:void 0;if(EventEmitter.listenerCount(C,"icecandidate")||EventEmitter.listenerCount(C,"candidategatheringdone"))if(n){var t;t=R&&usePlanB?w.candidateToUnifiedPlan(n):n,C.emit("icecandidate",t),D=!1}else D||(C.emit("candidategatheringdone"),D=!0);else D||(y.push(n),n||(D=!0))},p.onaddstream=n.onaddstream,p.onnegotiationneeded=n.onnegotiationneeded,this.on("newListener",function(e,n){if("icecandidate"===e||"candidategatheringdone"===e)for(;y.length;){var t=y.shift();!t==("candidategatheringdone"===e)&&n(t)}});var W=bufferizeCandidates(p);this.addIceCandidate=function(e,n){var t;t=R&&usePlanB?w.candidateToPlanB(e):new RTCIceCandidate(e),console.log("ICE candidate received"),n=(n||noop).bind(this),W(t,n)},this.generateOffer=function(n){n=n.bind(this);var t=!0,r=!0;u&&(t="boolean"==typeof u.audio?u.audio:!0,r="boolean"==typeof u.video?u.video:!0);var i="Firefox"===browser.name&&browser.version>34?{offerToReceiveAudio:"sendonly"!==e&&t,offerToReceiveVideo:"sendonly"!==e&&r}:{mandatory:{OfferToReceiveAudio:"sendonly"!==e&&t,OfferToReceiveVideo:"sendonly"!==e&&r},optional:[{DtlsSrtpKeyAgreement:!0}]},a=recursive(i,f);console.log("constraints: "+JSON.stringify(a)),p.createOffer(function(e){console.log("Created SDP offer"),e=o(e),p.setLocalDescription(e,function(){var e=p.localDescription;console.log("Local description set",e.sdp),R&&usePlanB&&(e=w.toUnifiedPlan(e),console.log("offer::origPlanB->UnifiedPlan",dumpSDP(e))),n(null,e.sdp,C.processAnswer.bind(C))},n)},n,a)},this.getLocalSessionDescriptor=function(){return p.localDescription},this.getRemoteSessionDescriptor=function(){return p.remoteDescription},this.showLocalVideo=function(){attachMediaStream(s,d),s.muted=!0},this.processAnswer=function(e,n){n=(n||noop).bind(this);var t=new RTCSessionDescription({type:"answer",sdp:e});if(R&&usePlanB){var o=w.toPlanB(t);console.log("asnwer::planB",dumpSDP(o)),t=o}return console.log("SDP answer received, setting remote description"),"closed"===p.signalingState?n("PeerConnection is closed"):void p.setRemoteDescription(t,function(){r(),n()},n)},this.processOffer=function(e,n){n=n.bind(this);var t=new RTCSessionDescription({type:"offer",sdp:e});if(R&&usePlanB){var i=w.toPlanB(t);console.log("offer::planB",dumpSDP(i)),t=i}return console.log("SDP offer received, setting remote description"),"closed"===p.signalingState?n("PeerConnection is closed"):void p.setRemoteDescription(t).then(function(){return r()}).then(function(){return p.createAnswer()}).then(function(e){return e=o(e),console.log("Created SDP answer"),p.setLocalDescription(e)}).then(function(){var e=p.localDescription;R&&usePlanB&&(e=w.toUnifiedPlan(e),console.log("answer::origPlanB->UnifiedPlan",dumpSDP(e))),console.log("Local description set",e.sdp),n(null,e.sdp)})["catch"](n)},"recvonly"===e||d||l?setTimeout(i,0):"webcam"===h?a(u):getScreenConstraints(h,function(e,n){return e?t(e):(constraints=[u],constraints.unshift(n),void a(recursive.apply(void 0,constraints)))},v),this.on("_dispose",function(){s&&(s.pause(),s.src="",s.load(),s.muted=!1),c&&(c.pause(),c.src="",c.load()),C.removeAllListeners(),void 0!==window.cancelChooseDesktopMedia&&window.cancelChooseDesktopMedia(v)})}function createEnableDescriptor(e){var n="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var t,r=0;t=e[r];r++)for(var o,i=t[n](),a=0;o=i[a];a++)if(!o.enabled)return!1;return!0}}},set:function(e){function t(n){n.enabled=e}this.peerConnection.getLocalStreams().forEach(function(e){e[n]().forEach(t)})}}}function WebRtcPeerRecvonly(e,n){return this instanceof WebRtcPeerRecvonly?void WebRtcPeerRecvonly.super_.call(this,"recvonly",e,n):new WebRtcPeerRecvonly(e,n)}function WebRtcPeerSendonly(e,n){return this instanceof WebRtcPeerSendonly?void WebRtcPeerSendonly.super_.call(this,"sendonly",e,n):new WebRtcPeerSendonly(e,n)}function WebRtcPeerSendrecv(e,n){return this instanceof WebRtcPeerSendrecv?void WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,n):new WebRtcPeerSendrecv(e,n)}function harkUtils(e,n){return hark(e,n)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),uuid=require("uuid"),hark=require("hark"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0),sdpTranslator=require("sdp-translator");try{require("kurento-browser-extensions")}catch(error){"undefined"==typeof getScreenConstraints&&(console.warn("screen sharing is not available"),getScreenConstraints=function(e,n){n(new Error("This library is not enabled for screen sharing"))})}var MEDIA_CONSTRAINTS={audio:!0,video:{width:640,framerate:15}},ua=window&&window.navigator?window.navigator.userAgent:"",parser=new UAParser(ua),browser=parser.getBrowser(),usePlanB=!1;"Chrome"!==browser.name&&"Chromium"!==browser.name||(console.log(browser.name+": using SDP PlanB"),usePlanB=!0);var dumpSDP=function(e){return"undefined"==typeof e||null===e?"":"type: "+e.type+"\r\n"+e.sdp};inherits(WebRtcPeer,EventEmitter),Object.defineProperties(WebRtcPeer.prototype,{enabled:{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}},audioEnabled:createEnableDescriptor("Audio"),videoEnabled:createEnableDescriptor("Video")}),WebRtcPeer.prototype.getLocalStream=function(e){return this.peerConnection?this.peerConnection.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){return this.peerConnection?this.peerConnection.getRemoteStreams()[e||0]:void 0},WebRtcPeer.prototype.dispose=function(){console.log("Disposing WebRtcPeer");var e=this.peerConnection;try{if(e){if("closed"===e.signalingState)return;e.getLocalStreams().forEach(streamStop),e.close()}}catch(n){console.warn("Exception disposing webrtc peer "+n)}this.emit("_dispose")},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv,exports.hark=harkUtils;
